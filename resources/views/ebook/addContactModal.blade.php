<div class="modal fade" id="addContact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <h2 style="color:rgba(31, 9, 9, 0.5);"><span class="glyph-icon icon-users" style="color: #65a6ff;font-size: 70px;"></span> Add to contacts</h2>
                            <br>
                ...
                <div class="content-box">
                    <form class="form-horizontal pad15L pad15R bordered-row">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">About contact:</label>
                            <div class="col-sm-6">
