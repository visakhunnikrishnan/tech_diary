@extends('master-template')
  ...
  @section('content')
    ...
    <div id="page-content" >
      ...
      <h2 style="color: rgba(132, 101, 101, 0.62);">Campaign preview</h2>
      <br><br>

        <div class="container-fluid">
            <h1>This is the campaign content</h1>
            <hr>
        ...
        <div class="container-fluid" style="text-align: center;padding: 3%;">
          <a href="campaigns-home" class="btn btn-info">Back to campaign home</a>
        </div>     
