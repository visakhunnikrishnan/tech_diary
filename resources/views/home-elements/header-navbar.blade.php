 <div id="page-header" class="bg-gradient-9">
    <div id="mobile-navigation">
        ...
        <a href="/" class="logo-content-small" title="Online Service Orchastration"></a>
    </div>
    
    <div id="header-logo" class="logo-bg">
        <a href="/" class="logo-content-big" title="Online Service Orchastration">
            Online Service <i>Orchastration</i>
            <span>The perfect solution for online marketting</span>
        </a>
        <a href="/" class="logo-content-small" title="Online Service Orchastration">
            Online Service <i>Orchastration</i>
            <span>The perfect solution for online marketting</span>
        </a>
