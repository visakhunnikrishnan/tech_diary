...
<div class="mail-header clearfix row">
    <div class="col-md-8">
        <span class="mail-title">Drafts</span>
...
@include('mailbox.drafts.draftsTable')
...
@include('mailbox.drafts.deleteModal')

@include('mailbox.drafts.sendModal')

@include('mailbox.drafts.bookmarkMail')
