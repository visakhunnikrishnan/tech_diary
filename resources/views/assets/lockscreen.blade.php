...
<title> Online Service Orchestration </title>
...
<img src="../../assets/image-resources/blurred-bg/blurred-bg-9.jpg" class="login-img wow fadeIn" alt="">
    ...
    <div class="center-content row">
        <div class="col-md-4 col-sm-5 col-xs-11 col-lg-3 center-margin ">
            <div class="content-box wow bounceInDown modal-content pad20A clearfix row">
                <div class="col-md-3">
                    <img src="../../assets/image-resources/gravatar.jpg" alt="" class="img-bordered border-gray radius-all-4 img-full">
                </div>
                <div class="col-md-9">
                    <div class="meta-box text-left">
                        <h3 class="meta-heading font-size-16">John Doe</h3>
                        <h4 class="meta-subheading font-size-13 font-gray">HR manager</h4>
